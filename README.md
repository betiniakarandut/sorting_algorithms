...
## Description
This project aim is to explore, learn and implement most well-known sorting algorithms. Explains Big O notation of time complexity.
These algorithms are fully implemented in C.
